...
public class Profile extends AppCompatActivity {
    ...
    private void saveUserData()
    {
        ...
        else
        {
            ...
            progressDialog.setMessage("please Wait..it takes some time");
            progressDialog.show();


            final StorageReference mStorage = userProfileImgRef
                    .child(FirebaseAuth.getInstance().getCurrentUser().getUid());
            final UploadTask uploadTask = mStorage.putFile(ImageUri);
    ...
    private void saveInfoOnlyWithoutImage()
    {
        ...
        if (getUserName.equals(""))
        {
            ...
            Toast.makeText(this, "user name is mandatary", Toast.LENGTH_SHORT).show();
        }
                    ...
                    .updateChildren(profileMap).addOnCompleteListener(new OnCompleteListener<Void>()
            {
                ...
                public void onComplete(@NonNull Task<Void> task)
                {
                    if(task.isSuccessful())
                    {
                        ...
                        Toast.makeText(Profile.this, "your profile information has been Updated", Toast.LENGTH_SHORT).show();
