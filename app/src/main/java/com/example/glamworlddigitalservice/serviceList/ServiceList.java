    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAdapter = new ServiceAdapter(ServiceList.this, mUploadServices);
                ...
                mAdapter.setOnItemClickListener(new ServiceAdapter.OnItemClickListener() {
                    ...
                    public void onItemCLick(int positon) {
                        ...
                        Intent intent = new Intent(ServiceList.this, NewActivity.class);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(ServiceList.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
                progressBar.setVisibility(View.INVISIBLE);
            }
        });
